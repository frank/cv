...
\begin{minipage}[t]{0.45\textwidth}
    \vspace{-\baselineskip}
    \cvsect{Skills}\\
    \texttt{Pytorch (Lightning)}\slashsep\texttt{Tensorboard}\slashsep\texttt{Slurm}\slashsep\texttt{Pandas}\slashsep\texttt{scikit-learn}\slashsep\texttt{pytest}\slashsep\texttt{gRPC}\slashsep\texttt{H5PY}\slashsep\texttt{OpenSlide}\slashsep\texttt{Docker}\slashsep\texttt{Singularity}
\end{minipage}
...
\entry
    ...
    \texttt{Pytorch (Lightning)}\slashsepb\texttt{Slurm}\slashsepb\texttt{scikit-learn}\slashsepb\texttt{pytest}\slashsepb\texttt{gRPC}\slashsepb\texttt{Docker}}
\entry
    {5/2021\,--\,7/2021}
